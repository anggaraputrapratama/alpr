...
class _PlatDeteksiState extends State<PlatDeteksi> {
  ...
  Future runLicenseDetect() async {
    ...
    // // contrast = image_.copyRotate(contrast!, 180);
    ...
    licenseDetect = (await licenseModel.getImagePrediction(
            await contrastImage!.readAsBytes(),
            minimumScore: 0.1,
            IOUThershold: 0.2))
    ...
    // const double imageWidth =imageDecode.width;
    // const double imageHeight = 800.0;
    ...
    int x = (boundingBox[0] * originalImage!.height).round();
    int y = (boundingBox[1] * originalImage.width).round();
    int width = (boundingBox[2] * originalImage.height).round();
    int height = (boundingBox[3] * originalImage.width).round();
        ...
        children: [
          contrastImage == null
              ...
              : !kDebugMode
                  ...
                  : licenseModel.renderBoxesOnImage(
                      contrastImage!, licenseDetect),
          BottomSheetCustom(
              size: size,
